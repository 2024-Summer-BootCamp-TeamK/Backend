...
['임금', '소정근로시간', '제55조에 따른 휴일', '제60조에 따른 연차 유급휴가', '그 밖에 대통령령으로 정하는 근로조건']이 
주어진 계약서에 명시되어 있는지와 어긋나지 않는지입니다. 
임금에 대해 확인할 때는 최저시급인 9860원보다 낮은지 확인합니다. 최저시급보다 높은 경우는 괜찮습니다. 낮은 경우만 문제가 됩니다.
