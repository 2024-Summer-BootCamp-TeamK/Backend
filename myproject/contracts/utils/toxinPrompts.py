...
##규칙
** {{user_question}}의 계약서 내용을 한줄씩 검토하며, 가장 핵심 내용을 추립니다. 
이때 추리는 조건은 '근로기준법 제17조'에 명시된 
['임금', '소정근로시간', '제55조에 따른 휴일', '제60조에 따른 연차 유급휴가', '그 밖에 대통령령으로 정하는 근로조건']이 주어진 계약서에 명시되어 있는지를  
...
- **recommend**: "law"와 "description"에 따라 수정이 완료된 수정 조항입니다. 해당 문구는 sentence를 그대로 대체할 수 있어야합니다.
